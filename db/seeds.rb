...
# Create costumes:
costume1 = Costume.create!(name: "Magician", size: "S", price_per_day: 10.00, category: "Kids", description: "Great magician costume for kids!", user: lender, address: "Kartoffelgleis 2, Munich")
...
costume4 = Costume.create!(name: "Dog Unicorn", size: "S", price_per_day: 12.00, category: "Pet", description: "Turn your dog into a unicorn and be happy :)!", user: lender2, address: "Viale Druso 5, Bolzano")
...
costume5 = Costume.create!(name: "Chef", size: "S", price_per_day: 14.00, category: "Kids", description: "Be an awesome chef (muffin not included)!", user: lender2, address: "Gotlandsgatan 3, Stockholm")
...
costume6 = Costume.create!(name: "Fairy", size: "M", price_per_day: 30.00, category: "Fantasy", description: "Great fairy costume, including nice wings!", user: lender2, address: "Hammer Landstrasse 15, Hamburg")
...
costume7 = Costume.create!(name: "Fire Woman", size: "S", price_per_day: 24.50, category: "Kids", description: "Save your neighborhood from fire - and have fun screaming at everyone with your megaphone!", user: lender2, address: "Bischofsweg 2, Frank")
